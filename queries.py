...
def print_top_authors():
    ...
    query = '''SELECT authors.name,SUM(popular_articles.views) AS number_of_view
...
def print_errors_over_one():
    ...
    query = '''SELECT to_char(num_of_success_by_day.date,'FMMonth dd yyyy'), round(num_of_error_by_day.numOfError*100.0/
